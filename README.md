...
Sessions are used to show the server what you have access to based on your authentication.
1. What does bcrypt do to help us store passwords in a secure manner.
It will encrypt your password by hashing it.
1. What does bcrypt do to slow down attackers?
Makes it difficult to decrypt your code.
